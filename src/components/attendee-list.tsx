        ...
        <div className="flex flex-col gap-4">
            <div className="flex gap-3 items-center">
                ...
                <div className="w-72 px-3 py-1.5 border border-white/10 rounded-lg flex items-center gap-3">
                    ...
                    <input onChange={onSearchInputChanged} value={search} className="bg-transparent flex-1 outline-none text-sm border-0 p-0 focus:ring-0" placeholder="Buscar participante..." />
                </div>
            </div>
